...
setup(
    name="jupyter-book-server-proxy",
    packages= ['jupyter_book_server_proxy'],
    include_package_data=True,
    #package_data={
    #    "jupyter_book_server_proxy": ["static/index.html",
    ...
    entry_points={
        'jupyter_serverproxy_servers': [
            'jupyter_book_server_proxy = jupyter_book_server_proxy:setup_jupyter_book',
        ]
    })
